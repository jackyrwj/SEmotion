...
#import sys
#sys.path.append('/raid/face_yy/IJBC/recognition')
#from IJB_11_Pytorch import read_template_media_list, read_template_pair_list, read_image_feature, get_image_feature, image2template_feature
# Support: ['get_time', 'get_val_pair', 'get_val_data', 'separate_irse_bn_paras', 'separate_resnet_bn_paras', 'separate_mobilefacenet_bn_paras', 'gen_plot', 'perform_val', 'buffer_val', 'AverageMeter', 'train_accuracy']
...
#     get_val_data('../../datasets/faces_webface_112x112/','lfw');
